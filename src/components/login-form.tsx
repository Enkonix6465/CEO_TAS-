...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-8", className)} {...props}>
      <Card className="enhanced-moving-border overflow-hidden p-0 shadow-2xl border-2 border-violet-300 dark:border-violet-500/40 bg-gradient-to-br from-white/85 to-violet-50/85 dark:bg-gradient-to-br dark:from-slate-900/90 dark:to-violet-800/90 backdrop-blur-2xl relative rounded-3xl">
        ...
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[650px]">
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center bg-gradient-to-br from-violet-50/95 to-purple-50/90 dark:from-slate-900/95 dark:to-violet-800/90 backdrop-blur-2xl relative rounded-l-3xl">
          ...
          <div className="relative hidden md:block bg-gradient-to-br from-violet-600 via-purple-700 to-indigo-900 dark:from-slate-800 dark:via-violet-800 dark:to-indigo-900 overflow-hidden rounded-r-3xl">
            {/* Enhanced glass morphism background */}
            <div className="absolute inset-0 bg-gradient-to-br from-violet-600/90 to-indigo-800/90 dark:from-slate-800/90 dark:to-violet-900/90 backdrop-blur-sm"></div>
