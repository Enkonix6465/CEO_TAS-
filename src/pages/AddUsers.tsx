...
export default function EmployeeManagement() {
  ...
  return (
          <div className="max-w-6xl mx-auto p-4 sm:p-6 text-gray-800 dark:text-purple-100 bg-gradient-to-br from-violet-50/95 via-purple-50/95 to-indigo-50/95 dark:bg-gradient-to-br dark:from-slate-900/95 dark:via-violet-900/95 dark:to-indigo-900/95 min-h-screen">
